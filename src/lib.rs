...
use base64::prelude::*;
use pb::substreams::v1::program::{Asset, AssetInfo};
...
fn map_option_asset(value: Option<idl::idl::program::types::Asset>) -> Option<Asset> {
    match value {
        Some(asset) => {
            return Some(Asset {
                token_address: asset.token_address.to_string(),
                amount: asset.amount as u64,
            })
        },
        None => {
            return None;
